...
export default function Home() {
  ...
  return (
   <main className="flex w-[100%] h-3/4  flex-col  ">

    
    <div className="main flex-1   h-9/12 w-full flex flex-row">
        <div className="text w-full h-full flex flex-col justify-center  ">
            <section>
                <h2  className="text-2xl mb-4">Software Developer</h2>
                <h1 className="text-8xl">Hello</h1>
                <h1 className="text-8xl text-accent">I'm Nursultan </h1>
            </section>
            <section className="my-10 text-xl flex flex-col gap-2 text-slate-300">
                <p>I am axcel at crafting digital axperince and </p>
                <p>I am profecient in various programming languages and technologies</p>
            </section>


            <section className=" mt-10 flex h-[200px] items-center justify-between">

                <Button className="text-3xl p-10 rounded-[40px] text-slate-200  hover:bg-transparent border-accent border-2 bg-transparent">Download CV</Button>
                <div className="flex gap-7">
                    <Link href={""} className="">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="#ffffff" className="w-[50px] h-auto  transition-all"  viewBox="0 0 20 20" version="1.1">
                        ...
                        <g fill="#ffffff" id="Page-1" stroke="none" stroke-width="1"  fill-rule="evenodd">
                            <g fill="#ffffff" id="Dribbble-Light-Preview" transform="translate(-140.000000, -7559.000000)" fill="#000000">
                                <g  fill="#ffffff" id="icons" transform="translate(56.000000, 160.000000)">
